    ...
    children: [
      ...
      },
      {
        tabulated: {
          ...
          align: 'left',
          field: row => row.loading_capacity,
          sortable: true,
          visible: true
        },
        actionable: {
          propTag: 'loading_capacity',
          addible: true,
          editable: true,
          type: 'String',
          visibleLabel: true,
      ...
      },
      {
        tabulated: {
          ...
          align: 'left',
          field: row => row.number_of_axles,
          sortable: true,
          visible: false
        },
        actionable: {
          propTag: 'number_of_axles',
          addible: true,
          editable: true,
          type: 'String',
          visibleLabel: true,
