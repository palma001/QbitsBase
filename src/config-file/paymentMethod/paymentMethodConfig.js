    ...
    children: [
      ...
      },
      {
        tabulated: {
          ...
          align: 'left',
          field: row => row.payment_destination.name,
          sortable: true,
          visible: true
        },
        actionable: {
          propTag: 'payment_destination',
          addible: true,
          editable: true,
          type: 'String',
          visibleLabel: true,
...
export const relationalDataConfiguration = [
  {
    targetPropTag: 'payment_destination',
    entity: 'payment_destination',
    services: ['payment-destinations'],
    propData: 'data',
    petitionParams: {
      paginate: false
    }
